...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ==================== CONTENT AREA ==================== */
        /* PERUBAHAN PENTING: Tambahkan margin-top dan margin-bottom
           untuk menghindari konten tertutup header/footer */
        .content-area {
            /* Sesuaikan nilai ini dengan tinggi header dan footer Anda */
        ...
        @media print {
            ...
            /* PENTING: Pastikan header dan footer tetap fixed saat print */
            .header-wrapper {
                position: fixed;
                top: 0;
            }
